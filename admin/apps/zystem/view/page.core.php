<?php
	$aSection = array(
		...
		array('initial'		,"Initial Setting",	'fa fa-rocket'),
		array('variable'	,"Variable",		'fa fa-terminal'),
		array('license'		,"Initial License",	'fa fa-id-badge'),
		array('setting'		,"Setting",			'fa fa-cogs'),
	);
?>
<div class="row">
	<div class="col-auto">
		...
		foreach($aSection as $sec){
			echo '<a class="nav-link'.($this->section==$sec[0]?" active":"").'" href="#/zystem/core/'.$sec[0].'" aria-selected="true">';
