	...
	App.loadPlugins(plugins, null).then(() => {
		...
		switch($panel->getView()){
			...
			case "overview":
				...
				include "control/controller.update.js";
				break;
			case "profile":
				include_once "../accctrl/control/controller.user.edit.js";
				//include_once "../accctrl/control/controller.address.js";
				include_once "../contact/control/controller.address.js";
				include_once "../profile/control/controller.profile.setting.js";
				include_once "../profile/control/controller.profile.quote.js";
				include_once "../engine/control/controller.file.upload.js";
				break;
				
			case "company":
				include "control/controller.company.edit.js";
				include "control/controller.company.photo.js";
				break;
			case "system":
