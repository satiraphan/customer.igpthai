fn.app.setting.system = {
	append_category : function(){
		var s = '';
		s += '<li class="dd-item dd-category"';
		...
		s += '>';
			s += '<div class="dd-handle">';
				s += '<div class="input-group">';
					s += '<span class="input-group-addon"><i class="fa fa-list"></i></span>';
	...
	save_general : function(){
		fn.confirmbox("Please confirm to save?","This action may affect the your structure! Are you sure to confirm this action?",function(){
			$.post('apps/setting/xhr/action-save-system-menu.php',$('#form_general').serialize(),function(response){
				if(response.success){	
	...
	dialog_add_app : function(btn){
		...
		fn.confirmbox("Please confirm to save?","This action may affect the your structure! Are you sure to confirm this action?",function(){
			$.post('apps/setting/xhr/action-save-system-menu.php',{data:JSON.stringify(data),available:$("select[name=available]").val()},function(response){
				if(response.success){	
					fn.successbox('Setting','Save complete',function(){
