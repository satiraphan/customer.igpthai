<?php
	...
	$iform->setForm("form_setting");
	
	$multiorgnaization = $os->load_variable("multiorgnaization","string");
	...
	$blueprint = array(
		...
		array(
			array(
				...
				"flex" => 4,
				"source" => array(
					array("navbar","Left Navigator"),
					array("topnav","Top Navigator")
				),
				"caption" => "Type",
				"value" => $os->load_variable("menutype","string")
			)
		),"hr",
		array(
			array(
				...
				"caption"=>"Photo Box",
				"name" => "aExampleImgs",
				"value" => $os->load_variable("aExampleImgs","string")
			),array(
				"type" => "button",
				"name" => "Dialog Photo",
				"onclick" => "fn.app.setting.company.dialog_photo()",
			...
			array(
				"type" => "button",
				"name" => "Save",
				"onclick" => "fn.app.setting.company.save_core()",
...
<div class="row">
	<div class="col-lg-12 col-xl-12 order-lg-12 order-xl-12">
		<div id="panel-1" class="panel">
			<div class="panel-hdr">
				<h2>Core System<span class="fw-300"><i>โปรดอย่าเปลี่ยแปลงหากไม่จำเป็น</i></span></h2>
			</div>
...
<div class="widget-body-toolbar">
	<div class="row">
		<div class="col-sm-6">
			<button id="enable" class="btn btn btn-outline-dark" onclick="fn.app.setting.company.dialog_edit()">
				แก้ไข
			</button>
		</div>
