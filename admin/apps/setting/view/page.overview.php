...
<div class="row">
	<div class="col">
		<ul class="list-group list-group-horizontal">
			...
			<li class="list-group-item flex-fill text-center">
				<div class="text-secondary">Version</div><strong><?php echo $version['version'];?></strong>
			</li>
		</ul>
	</div>
</div>
<div class="jumbotron handle bg-primary text-white mt-4" style="margin-bottom:0px;">
	<div class="container">
		<h1><?php echo $version['name'];?></h1>
		
		<dl class="row">
			<dt class="col-2"><?php echo $os->tr("overview.code_name");?></dt><dd class="col-10"><?php echo $version['code'];?></dd>
			<dt class="col-2"><?php echo $os->tr("overview.version");?></dt><dd class="col-10"><?php echo $version['version'];?></dd>
		...
		<p class="text-align-center">
			<a class="btn btn-success btn-lg mr-2" onclick="fn.system.check()">
				Lastest Update &nbsp; 
				<i class="fa fa-check"></i>
			</a>
			<a class="btn btn-dark btn-lg" onclick="$('form[name=form_uploader] input[name=file]').click();">Update &nbsp; <i class="fa fa-upload"></i></a>
		</p>
	</div>
</div>
<form name="form_uploader" class="d-none">
