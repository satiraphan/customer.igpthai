...
$('#tblDatabase').DataTable({
	...
	"processing": true,
	"serverSide": true,
	"ajax": "apps/database/store/geography/store-city.php",
	"aoColumns": [
		{"bSortable": false	,"data":"id"		,"sClass" : "text-center", "sWidth": "20px"},
		{"bSort" : true		,"data":"name"		,"sClass" : "text-center"},
		{"bSortable": true	,"data":"country"	,"sClass" : "text-center"},
	...
	"createdRow": function ( row, data, index ) {
		...
		s += fn.ui.button("btn btn-xs btn-outline-dark","far fa-pen","fn.app.database.city.dialog_edit("+data[0]+")");
		$('td', row).eq(3).html(s);
	}
});
