...
$('#tblDatabase').DataTable({
	...
	"processing": true,
	"serverSide": true,
	"ajax": "apps/database/store/geography/store-subdistrict.php",
	"aoColumns": [
		{"bSortable": false	,"data":"id"	,"sClass" : "text-center", "sWidth": "20px"},
		{"bSort" : true		,"data":"name"	,"sClass" : "text-center"},
		{"bSort" : true		,"data":"district"	,"sClass" : "text-center"},
	...
	"createdRow": function ( row, data, index ) {
		...
		s += fn.ui.button("btn btn-xs btn-outline-dark","far fa-pen","fn.app.database.subdistrict.dialog_edit("+data[0]+")");
		$('td', row).eq(5).html(s);
	}
});
