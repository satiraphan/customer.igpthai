 ...
 */
	...
	class iform extends iface{
		...
		function setForm($form_name,$action=""){
			$this->form_name = $form_name;
			$this->form_action = $action;
		}

		// Prepare for Depreciated
		...
		function EchoItem($control){
			...
			switch($type){
				...
				default:
					...
					$readonly = "";
					if(isset($control['readonly'])){$readonly = ' readonly="'.$control['readonly'].'"';}
	...
	class imodal extends iface{
		...
		function initiForm($form_name,$form_action=null){
			...
			$this->iform->setForm($form_name,$form_action);
		}
